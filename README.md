...
npm test         # expect: 1403 passed, 0 failed
```
...
tests/
  app.test.js       1403 checks: behaviour, layout, content accuracy, privacy
```
...
1403 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
