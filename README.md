...
npm test         # expect: 945 passed, 0 failed
```
...
tests/
  app.test.js       945 checks: behaviour, layout, content accuracy, privacy
```
...
945 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
