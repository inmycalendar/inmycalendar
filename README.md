...
npm test         # expect: 1177 passed, 0 failed
```
...
tests/
  app.test.js       1177 checks: behaviour, layout, content accuracy, privacy
```
...
1177 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
