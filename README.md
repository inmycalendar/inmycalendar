...
npm test         # expect: 1292 passed, 0 failed
```
...
tests/
  app.test.js       1292 checks: behaviour, layout, content accuracy, privacy
```
...
1292 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
