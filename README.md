...
npm test         # expect: 629 passed, 0 failed
```
...
tests/
  app.test.js       629 checks: behaviour, layout, content accuracy, privacy
```
...
629 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
