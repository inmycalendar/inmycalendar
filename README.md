...
npm test         # expect: 1417 passed, 0 failed
```
...
tests/
  app.test.js       1417 checks: behaviour, layout, content accuracy, privacy
```
...
1417 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
