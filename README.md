...
npm test         # expect: 1323 passed, 0 failed
```
...
tests/
  app.test.js       1323 checks: behaviour, layout, content accuracy, privacy
```
...
1323 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
