...
npm test         # expect: 998 passed, 0 failed
```
...
tests/
  app.test.js       998 checks: behaviour, layout, content accuracy, privacy
```
...
998 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
