...
npm test         # expect: 1411 passed, 0 failed
```
...
tests/
  app.test.js       1411 checks: behaviour, layout, content accuracy, privacy
```
...
1411 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
