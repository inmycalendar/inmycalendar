...
npm test         # expect: 634 passed, 0 failed
```
...
tests/
  app.test.js       634 checks: behaviour, layout, content accuracy, privacy
```
...
634 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
