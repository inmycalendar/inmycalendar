...
npm test         # expect: 982 passed, 0 failed
```
...
tests/
  app.test.js       982 checks: behaviour, layout, content accuracy, privacy
```
...
982 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
