...
npm test         # expect: 1179 passed, 0 failed
```
...
tests/
  app.test.js       1179 checks: behaviour, layout, content accuracy, privacy
```
...
1179 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
