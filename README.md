...
npm test         # expect: 657 passed, 0 failed
```
...
tests/
  app.test.js       657 checks: behaviour, layout, content accuracy, privacy
```
...
657 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
