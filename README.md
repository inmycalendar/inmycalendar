...
npm test         # expect: 1143 passed, 0 failed
```
...
tests/
  app.test.js       1143 checks: behaviour, layout, content accuracy, privacy
```
...
1143 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
