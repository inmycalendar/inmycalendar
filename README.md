...
npm test         # expect: 1387 passed, 0 failed
```
...
tests/
  app.test.js       1387 checks: behaviour, layout, content accuracy, privacy
```
...
1387 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
