...
npm test         # expect: 1136 passed, 0 failed
```
...
tests/
  app.test.js       1136 checks: behaviour, layout, content accuracy, privacy
```
...
1136 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
