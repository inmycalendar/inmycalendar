...
npm test         # expect: 1171 passed, 0 failed
```
...
tests/
  app.test.js       1171 checks: behaviour, layout, content accuracy, privacy
```
...
1171 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
