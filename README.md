...
npm test         # expect: 1125 passed, 0 failed
```
...
tests/
  app.test.js       1125 checks: behaviour, layout, content accuracy, privacy
```
...
1125 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
