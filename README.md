...
npm test         # expect: 518 passed, 0 failed
```
...
tests/
  app.test.js       518 checks: behaviour, layout, content accuracy, privacy
```
...
518 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
