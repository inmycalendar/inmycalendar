...
npm test         # expect: 1244 passed, 0 failed
```
...
tests/
  app.test.js       1244 checks: behaviour, layout, content accuracy, privacy
```
...
1244 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
