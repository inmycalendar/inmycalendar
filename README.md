...
npm test         # expect: 1231 passed, 0 failed
```
...
tests/
  app.test.js       1231 checks: behaviour, layout, content accuracy, privacy
```
...
1231 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
