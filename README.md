...
npm test         # expect: 1111 passed, 0 failed
```
...
tests/
  app.test.js       1111 checks: behaviour, layout, content accuracy, privacy
```
...
1111 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
