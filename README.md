...
npm test         # expect: 598 passed, 0 failed
```
...
tests/
  app.test.js       598 checks: behaviour, layout, content accuracy, privacy
```
...
598 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
