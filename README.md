...
npm test         # expect: 1477 passed, 0 failed
```
...
tests/
  app.test.js       1477 checks: behaviour, layout, content accuracy, privacy
```
...
1477 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
