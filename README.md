...
npm test         # expect: 1076 passed, 0 failed
```
...
tests/
  app.test.js       1076 checks: behaviour, layout, content accuracy, privacy
```
...
1076 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
