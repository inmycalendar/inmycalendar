...
npm test         # expect: 969 passed, 0 failed
```
...
tests/
  app.test.js       969 checks: behaviour, layout, content accuracy, privacy
```
...
969 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
