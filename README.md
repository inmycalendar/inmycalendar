...
npm test         # expect: 675 passed, 0 failed
```
...
tests/
  app.test.js       675 checks: behaviour, layout, content accuracy, privacy
```
...
675 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
