...
npm test         # expect: 1348 passed, 0 failed
```
...
tests/
  app.test.js       1348 checks: behaviour, layout, content accuracy, privacy
```
...
1348 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
