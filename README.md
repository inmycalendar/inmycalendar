...
npm test         # expect: 1498 passed, 0 failed
```
...
tests/
  app.test.js       1498 checks: behaviour, layout, content accuracy, privacy
```
...
1498 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
