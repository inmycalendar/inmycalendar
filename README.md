...
npm test         # expect: 979 passed, 0 failed
```
...
tests/
  app.test.js       979 checks: behaviour, layout, content accuracy, privacy
```
...
979 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
