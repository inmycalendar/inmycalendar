...
npm test         # expect: 1495 passed, 0 failed
```
...
tests/
  app.test.js       1495 checks: behaviour, layout, content accuracy, privacy
```
...
1495 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
