...
npm test         # expect: 897 passed, 0 failed
```
...
tests/
  app.test.js       897 checks: behaviour, layout, content accuracy, privacy
```
...
897 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
