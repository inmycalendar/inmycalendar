...
npm test         # expect: 931 passed, 0 failed
```
...
tests/
  app.test.js       931 checks: behaviour, layout, content accuracy, privacy
```
...
931 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
