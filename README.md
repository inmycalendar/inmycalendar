...
npm test         # expect: 1418 passed, 0 failed
```
...
tests/
  app.test.js       1418 checks: behaviour, layout, content accuracy, privacy
```
...
1418 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
