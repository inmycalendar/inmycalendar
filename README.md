...
npm test         # expect: 1219 passed, 0 failed
```
...
tests/
  app.test.js       1219 checks: behaviour, layout, content accuracy, privacy
```
...
1219 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
