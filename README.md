...
npm test         # expect: 1500 passed, 0 failed
```
...
tests/
  app.test.js       1500 checks: behaviour, layout, content accuracy, privacy
```
...
1500 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
