...
npm test         # expect: 1561 passed, 0 failed
```
...
tests/
  app.test.js       1561 checks: behaviour, layout, content accuracy, privacy
```
...
1561 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
