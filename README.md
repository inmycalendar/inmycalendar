...
npm test         # expect: 1552 passed, 0 failed
```
...
tests/
  app.test.js       1552 checks: behaviour, layout, content accuracy, privacy
```
...
1552 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
