...
npm test         # expect: 1140 passed, 0 failed
```
...
tests/
  app.test.js       1140 checks: behaviour, layout, content accuracy, privacy
```
...
1140 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
