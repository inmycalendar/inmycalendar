...
npm test         # expect: 805 passed, 0 failed
```
...
tests/
  app.test.js       805 checks: behaviour, layout, content accuracy, privacy
```
...
805 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
