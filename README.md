...
npm test         # expect: 578 passed, 0 failed
```
...
tests/
  app.test.js       578 checks: behaviour, layout, content accuracy, privacy
```
...
578 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
