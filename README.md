...
npm test         # expect: 1278 passed, 0 failed
```
...
tests/
  app.test.js       1278 checks: behaviour, layout, content accuracy, privacy
```
...
1278 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
