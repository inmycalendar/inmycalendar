...
npm test         # expect: 661 passed, 0 failed
```
...
tests/
  app.test.js       661 checks: behaviour, layout, content accuracy, privacy
```
...
661 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
