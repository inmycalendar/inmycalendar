...
npm test         # expect: 1093 passed, 0 failed
```
...
tests/
  app.test.js       1093 checks: behaviour, layout, content accuracy, privacy
```
...
1093 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
