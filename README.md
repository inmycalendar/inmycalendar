...
npm test         # expect: 1176 passed, 0 failed
```
...
tests/
  app.test.js       1176 checks: behaviour, layout, content accuracy, privacy
```
...
1176 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
