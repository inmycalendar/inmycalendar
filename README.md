...
npm test         # expect: 1515 passed, 0 failed
```
...
tests/
  app.test.js       1515 checks: behaviour, layout, content accuracy, privacy
```
...
1515 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
