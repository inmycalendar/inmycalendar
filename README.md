...
npm test         # expect: 521 passed, 0 failed
```
...
tests/
  app.test.js       521 checks: behaviour, layout, content accuracy, privacy
```
...
521 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
