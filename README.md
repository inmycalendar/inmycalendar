...
npm test         # expect: 1565 passed, 0 failed
```
...
tests/
  app.test.js       1565 checks: behaviour, layout, content accuracy, privacy
```
...
1565 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
