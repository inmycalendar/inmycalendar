...
npm test         # expect: 1277 passed, 0 failed
```
...
tests/
  app.test.js       1277 checks: behaviour, layout, content accuracy, privacy
```
...
1277 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
