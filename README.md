...
npm test         # expect: 1389 passed, 0 failed
```
...
tests/
  app.test.js       1389 checks: behaviour, layout, content accuracy, privacy
```
...
1389 checks against a real DOM (`jsdom`), driving the app with synthetic clicks and keystrokes
